...
function showGameInfo() {
  var modal = document.querySelector(".game-info");
  var closeBtn = modal.querySelector(".game-info__close-btn");
  var modalChildren = (0, _toConsumableArray2.default)(modal.children);
  modalChildren.forEach(function (child) {
    return child.style.opacity = "1";
  });
  modal.classList.add("game-info--active");
  closeBtn.addEventListener("click", function () {
    return closeModal(modal, modalChildren);
  });
}
...
},{"@babel/runtime/helpers/toConsumableArray":"../node_modules/@babel/runtime/helpers/toConsumableArray.js"}],"../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
},{}],"js/randomWord.js":[function(require,module,exports) {
"use strict";
...
function randomWord() {
  return _randomWord.apply(this, arguments);
}

function _randomWord() {
  _randomWord = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var randomWordURL, response, data;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            randomWordURL = "https://random-words-api.herokuapp.com/w?n=1";
            _context.prev = 1;
            _context.next = 4;
            return fetch(randomWordURL);
          ...
          case 11:
            ...
            throw new Error("Could not get word", _context.t0);
...
;
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js"}],"../node_modules/@babel/runtime/helpers/arrayWithHoles.js":[function(require,module,exports) {
...
function endGame(result) {
  var gameEndModal = document.querySelector(".end-game-modal");
  var title = gameEndModal.querySelector(".end-game-modal__title");
  var subTitle = gameEndModal.querySelector(".end-game-modal__subtitle");
  var button = gameEndModal.querySelector(".end-game-modal__button");
...
function animateModalElements(title, subTitle, button) {
  _gsap.default.fromTo([title, subTitle], {
    opacity: 0,
    y: '-100'
  }, {
    duration: .5,
...
},{"gsap":"../node_modules/gsap/index.js"}],"js/animateHangman.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = animateHangman;

var _gsapCore = _interopRequireDefault(require("gsap/gsap-core"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function animateHangman(currentLife) {
  var gallowLegs = document.querySelector("#gallows-legs");
  var stem = document.querySelector("#stem");
  var pillar = document.querySelector("#pillar");
  var crossbeam = document.querySelector("#crossbeam");
  var line = document.querySelector("#line");
  var hangmanHead = document.querySelector("#hangman-head");
  var hangmanTorso = document.querySelector("#hangman-torso");
  var hangmanLeftArm = document.querySelector("#hangman-left-arm");
  var hangmanRightArm = document.querySelector("#hangman-right-arm");
  var hangmanLegs = document.querySelector("#hangman-legs");

  switch (currentLife) {
    case 10:
      entranceAnimation(gallowLegs, stem, pillar, crossbeam, line, hangmanHead, hangmanTorso, hangmanLeftArm, hangmanRightArm, hangmanLegs);
      break;
...
function entranceAnimation() {
  var tl = _gsapCore.default.timeline();
...
function gallowLegsAnimation(element) {
  _gsapCore.default.fromTo(element, {
    opacity: 0,
    y: "+100"
  }, {
    duration: 0.3,
...
function stemAnimation(mainElement, secondaryElement) {
  _gsapCore.default.set(secondaryElement, {
    rotate: "90deg",
    y: "100",
    transformOrigin: "left bottom"
  });

  _gsapCore.default.set(mainElement, {
    opacity: 0,
    y: "+100"
  });
...
},{"gsap/gsap-core":"../node_modules/gsap/gsap-core.js"}],"js/initGame.js":[function(require,module,exports) {
"use strict";
...
var _animateHangman = _interopRequireDefault(require("./animateHangman"));
...
function initGame(object) {
  ...
  var _getWordDefinition = getWordDefinition(definitions),
      wordDefinition = _getWordDefinition.definition;
  ...
  animateKeyboard();
  (0, _animateHangman.default)(playerLifes);
  ...
  function listenForEvents() {
    keyboard.addEventListener("click", function (_ref) {
      var target = _ref.target;
      var letter = target.getAttribute("value");
      if (!letter) return;
      usedLetters.push(letter);
      var result = checkLetter(letter, word);

      if (result === false) {
        playerLifes--;
        (0, _animateHangman.default)(playerLifes);
        var gameResult = checkLifes(playerLifes, word);
        gameIsOver = gameResult;
      } else {
        var _gameResult = checkLifes(playerLifes, word);

        gameIsOver = _gameResult;
      }

      markUsedLetters(usedLetters);
    });
    window.addEventListener("keypress", function (_ref2) {
      var letter = _ref2.key,
      ...
      if (keyCode >= 97 && keyCode <= 122 || which >= 97 && which <= 122) {
        ...
        if (result === false) {
          ...
          var _gameResult2 = checkLifes(playerLifes, word);

          gameIsOver = _gameResult2;
        }
...
function markUsedLetters(array) {
  var keyboardKeys = document.querySelectorAll(".keyboard__key");
...
function checkIfWon(word) {
  var secretWordLetters = (0, _toConsumableArray2.default)(document.querySelector(".secret-word").children);
  var secretWordLettersArray = secretWordLetters.map(function (el) {
    return el.textContent.toLowerCase();
  });
  if (word.toLowerCase() === secretWordLettersArray.join("")) (0, _endGame.default)("win");
}

var checkLifes = function checkLifes(lifes, word) {
  return lifes > 0 ? checkIfWon(word) : (0, _endGame.default)("lose");
};

function checkIfGuessed(previousLength, currentLength) {
  if (previousLength < currentLength) return true;else return false;
}

function checkLetter(letter, word) {
  var wordArray = word.split("");
  var secretWordContainer = (0, _toConsumableArray2.default)(document.querySelector(".secret-word").children);
  var lengthBeforeWordCheking = checkLength(secretWordContainer);
  ...
  var lengthAfterWordCheking = checkLength(secretWordContainer);
...
function updateDefinition(wordDefinition) {
  var definitionBox = document.querySelector(".definition-box");
  var definitionText = definitionBox.querySelector("span");

  _gsapCore.default.fromTo(definitionBox, {
    opacity: 0,
    y: "-100"
  }, {
    duration: 0.3,
...
function updateSecretWord(word) {
  var wordArray = (0, _toConsumableArray2.default)(word);
  var secretWordContainer = document.querySelector(".secret-word");
  ...
  _gsapCore.default.fromTo((0, _toConsumableArray2.default)(secretWordContainer.children), {
    opacity: 0,
    x: "100"
  }, {
    opacity: 1,
...
function animateKeyboard() {
  var keyboardKey = (0, _toConsumableArray2.default)(document.querySelectorAll(".keyboard__row"));

  _gsapCore.default.fromTo(keyboardKey, {
    opacity: 0,
    y: "+100"
  }, {
    opacity: 1,
...
},{"@babel/runtime/helpers/toConsumableArray":"../node_modules/@babel/runtime/helpers/toConsumableArray.js","gsap/gsap-core":"../node_modules/gsap/gsap-core.js","./endGame":"js/endGame.js","./animateHangman":"js/animateHangman.js"}],"js/getWordDefinitions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = getWordDefinitions;
...
var _initGame = _interopRequireDefault(require("./initGame"));

var _startGame = _interopRequireDefault(require("./startGame"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function getWordDefinitions(_x) {
  return _getWordDefinitions.apply(this, arguments);
}

function _getWordDefinitions() {
  _getWordDefinitions = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(array) {
    var _array, word, definitionsAPIURL, response, data;

    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _array = (0, _slicedToArray2.default)(array, 1), word = _array[0];
            definitionsAPIURL = "https://wordsapiv1.p.rapidapi.com/words/".concat(word, "/definitions");
            _context.prev = 2;
            _context.next = 5;
            return fetch(definitionsAPIURL, {
              method: "GET",
              headers: {
          ...
          case 8:
            data = _context.sent;
            return _context.abrupt("return", (0, _initGame.default)(data));

          case 12:
            _context.prev = 12;
            _context.t0 = _context["catch"](2);
            (0, _startGame.default)();
            throw new Error("Could not get word definition", _context.t0);
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/slicedToArray":"../node_modules/@babel/runtime/helpers/slicedToArray.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","./initGame":"js/initGame.js","./startGame":"js/startGame.js"}],"js/startGame.js":[function(require,module,exports) {
"use strict";
...
var _randomWord = _interopRequireDefault(require("./randomWord"));

var _getWordDefinitions = _interopRequireDefault(require("./getWordDefinitions"));
...
function startGame() {
  scrollToGame();
  removeTabIndex();
  var logoContainer = document.querySelector(".game__header .logo-container");
  (0, _randomWord.default)().then(function (data) {
    return (0, _getWordDefinitions.default)(data);
  });
...
;
},{"gsap":"../node_modules/gsap/index.js","./randomWord":"js/randomWord.js","./getWordDefinitions":"js/getWordDefinitions.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./../assets/wave.svg":[["wave.dd4360d6.svg","assets/wave.svg"],"assets/wave.svg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/index.js":[function(require,module,exports) {
"use strict";

var _showGameInfo = _interopRequireDefault(require("./showGameInfo"));
...
window.addEventListener("DOMContentLoaded", function () {
  var gameStartBtn = document.querySelector(".game-start-btn");
  var gameInfoBtn = document.querySelector(".game-info-btn");
  gameStartBtn.addEventListener("click", _startGame.default);
  gameInfoBtn.addEventListener("click", _showGameInfo.default);
});
},{"./showGameInfo":"js/showGameInfo.js","./startGame":"js/startGame.js","../scss/main.scss":"scss/main.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
